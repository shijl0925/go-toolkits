...
func TestShuffle_MultipleElements(t *testing.T) {
	...
	if reflect.DeepEqual(input, originalCopy) {
...
func TestShuffle_DifferentDataTypes(t *testing.T) {
	...
	if reflect.DeepEqual(intInput, originalIntCopy) {
	...
	if reflect.DeepEqual(stringInput, originalStringCopy) {
	...
	if reflect.DeepEqual(structInput, originalStructCopy) {
