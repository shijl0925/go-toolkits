...
func gormxExecutionScenarios() []dbScenario {
	scenarios := []dbScenario{
		...
		{name: "UseDB_ReplacesGlobalDB", test: TestUseDB_ReplacesGlobalDB},
		{name: "UseDB_SubsequentOptsApplied", test: TestUseDB_SubsequentOptsApplied},
		{name: "UseDB_Transaction_Rollback", test: TestUseDB_WithTransaction_Rollback},
		{name: "UseDB_Transaction_Commit", test: TestUseDB_WithTransaction_Commit},
		{name: "UseDB_Context_CancelledContext", test: TestUseDB_WithContext_CancelledContext},
